...
#define TEXT_FILE     "./files/text.txt"
#define HANDLED_FILE  "./files/new_text.txt"
#define SYMB_QTY_FILE "./files/symb_qty.txt"


#define MAX_WORD_SIZE  100

#define START_LIST_LEN 50

#define TYPE_LIST       char*

// search.cpp
#define ELEM_NOT_FOUND -1
#define ELEM_IS_FOUND  1

#define HASH_TABLE_SIZE 257
#define START_LIST_SIZE 3

#define CONST_FILE_NAME  "./files/const.txt"
#define FIRST_ASCII_NAME "./files/first_ascii.txt"
#define LENGTH_NAME      "./files/length.txt"
#define SHIFT_RIGHT_NAME "./files/right.txt"
#define SHIFT_LEFT_NAME  "./files/left.txt"
